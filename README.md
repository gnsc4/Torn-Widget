...
You can download the latest version (v1.0.42) of the Torn Status Widget for your operating system from the [**Releases page**](https://github.com/gnsc4/Torn-Widget/releases/tag/v1.0.42) on GitHub.

### Windows

1.  From the [v1.0.42 release assets](https://github.com/gnsc4/Torn-Widget/releases/tag/v1.0.42), download either:
...
1.  From the [v1.0.42 release assets](https://github.com/gnsc4/Torn-Widget/releases/tag/v1.0.42), download the appropriate installer for your distribution:
